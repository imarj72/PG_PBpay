         ...
         onChange={handleNameChange}
              ...
              />
                ...
                <Grid item md={12} xs={12} className='autopay-check'>
                    <FormGroup>
                        <FormControlLabel control={<Checkbox id="autopayChecked" defaultChecked disabled={displayMode === 6 || displayMode === 5} onChange={handleCheckboxChange}  />} label="Set up Autopay on your Debit Card if applicable" />
                    </FormGroup>
